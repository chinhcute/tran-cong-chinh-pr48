   ...
   <body>
     <header>
           <article style=" width: 600px; height: 30px;padding-top: 13px; padding-left: 300px;">
               <form action="">
                   <input style="height: 30px; width: 500px;" tabindex="1"  type="text" placeholder="nhập dữ liệu" autofocus>
       ...
       <main >
           <section style="display: flex;">
               <p style="height: 30px; width: 90px; background-color: red; font-size: 15px;  padding: 5px 0 0 6px  ; box-sizing: border-box;"><a href="add-sanpham">Add</a> </p>
           ...
           <table  style="width: 1000px; border-collapse: collapse; margin: 20px 30px;">
               <tr>
                ...
                <c:forEach items="${listOder}" var="detail">
                 <tr>
                         <td>${detail.orderDetailsId}</td>
                          ...
                          <th>
                             <a href="/edit/${detail.orderDetailsId}">
                                 Edit
                              </a>
                          </th>
               </tr>
